...
public class CountdownView extends View {
     ...
     */
    public void start(long targetTime) {
        ...
        if (isShowMillisecond) {
            ...
            updateShow(targetTime - new Date().getTime());
        } else {
            countDownInterval = 1000;
        }

        mCustomCountDownTimer = new CustomCountDownTimer(countDownInterval) {
            @Override
    ...
    public abstract class CustomCountDownTimer {
         ...
         */
        public CustomCountDownTimer(long countDownInterval) {
            mCountdownInterval = countDownInterval;
        }

        private synchronized CustomCountDownTimer start() {
            isStop = false;
            if (mTargetTime - new Date().getTime() <= 0) {
                onFinish();
                return this;
            }
        ...
        private Handler mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                synchronized (CustomCountDownTimer.this) {
                    ...
                    final long millisLeft = mTargetTime - new Date().getTime();
                    if (millisLeft <= 0) {
                        onFinish();
                    } else {
