...
package com.zsjx.store.homepage.lib.network.persistentcookiejar.persistence;
...
public class SharedPrefsCookiePersistor implements CookiePersistor {
    ...
    public List<Cookie> loadAll() {
        ...
        for (Map.Entry<String, ?> entry : sharedPreferences.getAll().entrySet()) {
            ...
            if (cookie != null) {
                Logger.d("cookie-loadAll-add:" + cookies);
                cookies.add(cookie);
            } else {
                Logger.d("cookie-loadAll-remove:" + cookies);
        ...
        Logger.d("cookie-loadAll:" + cookies);
        return cookies;
    }
